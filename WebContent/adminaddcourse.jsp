...
<body>
<form method="post" action="<%=response.encodeURL(request.getContextPath() + "/CourseController?action=create")%>">
<input type="hidden" name="user" value="<%=session.getAttribute("user")%>"/>
<h1 style="text-align: center; margin-top:2%;">Add Course</h1>
...
<p>Prospects</p> <textarea class = "form-control" rows="4" cols="50" name="prospects" style="margin-top:-1.5%;"></textarea>
