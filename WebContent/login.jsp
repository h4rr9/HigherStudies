...
<style>
body {
	background-image: url("/HigherStudies/stylesheets/4.jpg");
...
<body>
    ...
    <h2 style="text-align: center; margin-top: 6%; color:white; ">Login</h2>

    <form method="post" action="<%= response.encodeURL(request.getContextPath() + "/MainController?action=dologin") %>">
      <center>
        <div style="background-color: inherit; margin-top: 4%; height: 500px; width: 448px;">
